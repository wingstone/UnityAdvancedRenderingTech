...
public class VolumetricFog : MonoBehaviour
{
    ...
    private void Render()
    {
        ...
        computeShader.SetVector("_PointPosition", pointPosition);
        computeShader.SetVector("_PointColor", pointColor);
        computeShader.SetFloat("_PhaseG", phaseG);
    ...
    public Vector4 pointPosition = new Vector4(0, 0, 0, 1);
    [ColorUsage(false, true)]
    public Color pointColor = Color.yellow;
    [Range(-1,1)]
    public float phaseG = 0;

    private void OnDrawGizmos()
    {
        Gizmos.DrawWireSphere(new Vector3(pointPosition.x, pointPosition.y, pointPosition.z), pointPosition.w);
    }
}
