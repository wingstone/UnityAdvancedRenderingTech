...
void ReadBlockRGB(Texture2D<float4> SourceTexture, SamplerState TextureSampler, float2 UV, float2 TexelUVSize, out float3 Block[16], out float BlockA[16])
{
	{
        ...
        BlockA[0] = float(Alpha[3]);
        BlockA[1] = float(Alpha[2]);
        BlockA[4] = float(Alpha[0]);
        BlockA[5] = float(Alpha[1]);
    }
	{
        ...
        BlockA[2] = float(Alpha[3]);
        BlockA[3] = float(Alpha[2]);
        BlockA[6] = float(Alpha[0]);
        BlockA[7] = float(Alpha[1]);
    }
	{
        ...
        BlockA[8] = float(Alpha[3]);
        BlockA[9] = float(Alpha[2]);
        BlockA[12] = float(Alpha[0]);
        BlockA[13] = float(Alpha[1]);
    }
	{
        ...
        BlockA[10] = float(Alpha[3]);
        BlockA[11] = float(Alpha[2]);
        BlockA[14] = float(Alpha[0]);
        BlockA[15] = float(Alpha[1]);
    }
}
