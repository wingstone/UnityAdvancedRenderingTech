...
CBUFFER_START(_Terrain)
    ...
    float4 _CameraPage;
    float4 _CameraUV;
    int _MipStepPageCount;
    int _PageResolution;
    int _VTResolution;
    int _VTPageResolution;
    int _VTMips;
    int _PhysicalResolution;
    int _PhysicalPageResolution;
...
//--- vt paramters
TEXTURE2D(_PhysicalAlbedoTex);    SAMPLER(sampler_PhysicalAlbedoTex);
TEXTURE2D(_PhysicalNormalTex);    SAMPLER(sampler_PhysicalNormalTex);
TEXTURE2D(_PageTable);     SAMPLER(sampler_PageTable);
