...
Shader "Universal Render Pipeline/Simple Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/SRP/Shaders/SimpleLitInput.hlsl"
            #include "Assets/SRP/Shaders/SimpleLitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/SRP/Shaders/SimpleLitInput.hlsl"
            #include "Assets/SRP/Shaders/ShadowCasterPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/SRP/Shaders/SimpleLitInput.hlsl"
            #include "Assets/SRP/Shaders/DepthOnlyPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/SRP/Shaders/SimpleLitInput.hlsl"
            #include "Assets/SRP/Shaders/SimpleLitMetaPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/SRP/Shaders/SimpleLitInput.hlsl"
            #include "Assets/SRP/Shaders/Utils/Universal2D.hlsl"
            ENDHLSL
        }
    }
