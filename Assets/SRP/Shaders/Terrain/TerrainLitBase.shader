Shader "Hidden/Universal Render Pipeline/Terrain/Lit (Base Pass)"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/SRP/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Assets/SRP/Shaders/Terrain/TerrainLitPasses.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/SRP/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Assets/SRP/Shaders/Terrain/TerrainLitMetaPass.hlsl"
